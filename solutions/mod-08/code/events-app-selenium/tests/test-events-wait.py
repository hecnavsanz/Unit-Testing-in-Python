...
class TestSimpletest:
    ...
    def test_simpletest(self, setup_driver):
        ...
        element = WebDriverWait(setup_driver, 6).until(lambda d: d.find_element(By.ID, "navbarDropdown"))
        element.click()
        ...
        element = WebDriverWait(setup_driver, 6).until(lambda d: d.find_element(By.CSS_SELECTOR, "#eventModal .btn"))
        element.click()
        ...
        element = WebDriverWait(setup_driver, 6).until(lambda d: d.find_element(By.LINK_TEXT, "Home"))
        element.click()
