...
class TestCustomerController:
    ...
    def test_get_by_id(self):
        ...
        # `controller.get_by_id() ` must raise an exception, if not you will see the following error:
        #   Failed: DID NOT RAISE <class 'models.customer_exception.CustomerNotFoundException'>
