...
from models.customer_exceptions import CustomerWithoutIdException
...
class Customer(Model):
    ...
    # string representation of the customer to print
    def __str__(self):
        return json.dumps({'cust_id': str(self.__idn), 'cust_name': self.__name, 'cust_email': self.__email,
    ...
    def __eq__(self, other):
        return self.__name == other.name and self.__email == other.email and self.__phone == other.phone
